...
# the baseTask is just a abstract class.
class LinkPrediction(BaseTask):
    ...
    def __init__(self, args):
        ...
        # the get_split() is the dataset/linkprediction
        ...
        if self.val_hg is None and self.test_hg is None:
            ...
            self.val_hg = self.val_hg.to("cuda:0")
            self.test_hg = self.test_hg.to("cuda:0")
        self.evaluator = Evaluator(args.seed) # evaluate method
    ...
    def construct_negative_graph(self, hg):
        e_dict = {
            ...
            for etype in hg.canonical_etypes} # e_dict store the idx of the edges
            ...
            for ntype in edge_subgraph.ntypes:
                ...
                for etype in edge_subgraph.canonical_etypes:
                    edge_subgraph.apply_edges(
                        dgl.function.u_dot_v('x', 'x', 'score'), etype=etype) # the score is the output = x*x
