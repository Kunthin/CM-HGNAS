...
def build_dataset(dataset, task, *args, **kwargs):
    ...
    # 'HGBl-amazon', 'HGBl-LastFM','HGBl-ACM', 'HGBl-DBLP', 'HGBl-IMDB' this five dataset
        ...
        _dataset = 'hin_' + task  # here is what we needed
    elif dataset in ohgbn_datasets + ohgbn_datasets:
        _dataset = 'ohgb_' + task
    elif dataset in ['ogbn-mag']:
        _dataset = 'ogbn_' + task
    elif dataset in hgbn_datasets:  # here is what we needed
        _dataset = 'HGBn_node_classification'
    elif dataset in hgbl_datasets:
        _dataset = 'HGBl_link_prediction'  # here is what we needed
        ...
        _dataset = task
    # print(DATASET_REGISTRY[_dataset](dataset, logger=kwargs['logger']))
