...
# it will auto call the download function
class HGBDataset(DGLDataset):
    ...
    def __init__(self, name, raw_dir=None, force_reload=False, verbose=True):
        ...
        # these dataset is all we need, so the class is very important
    ...
    def process(self):
        ...
        print("the length of the graphlist is ",len(g))
        self._g = g[0]
        # here the g return the graph
        # self._g = self._g.to("cuda:0") maybe here we need this line
