...
class Trainer(object):
    ...
    def train_shared(self, max_step=50, gnn_list=None):
        ...
        for gnn in gnn_list:
            ...
            try:
                ...
                nas_Logger.info(f"{gnn}, val_score:{val_score}")
    ...
    def evaluate(self, gnn):
        ...
        nas_Logger.info(f'eval | {gnn} | reward: {reward:8.2f} | scores: {scores:8.2f}')
    ...
    def derive(self, sample_num=None):
        ...
        if sample_num is None and self.args.derive_from_history:
            ...
            nas_Logger.info(f'derive |action:{best_actions} |max_R: {max_R:8.6f}')
    ...
    def save_model(self):
        ...
        nas_Logger.info(f'[*] SAVED: {self.controller_path}')
    ...
    def load_model(self):
        ...
        if len(epochs) == 0:
            nas_Logger.info(f'[!] No checkpoint found in {self.args.dataset}...')
            return
        ...
        nas_Logger.info(f'[*] LOADED: {self.controller_path}')
